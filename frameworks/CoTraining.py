...
class CoTrainingModel(object):
    """
    Co-Training semi-supervised learning framework from (Blum, Mitchell 1998).

    Ref:
        - Original repository: https://github.com/jjrob13/sklearn_cotraining
    ...
    def __init__(self, clf, clf2=None, p=-1, n=-1, k=30, u = 75, random_state=42):
        self.clf1_ = clf
